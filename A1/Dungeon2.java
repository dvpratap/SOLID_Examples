...
public class Dungeon2 implements Dungeon{
    ...
    private int dungeonId = 2;

    public void displayDungeonEnv(Player p1){
        System.out.println("\t ### you are now in Elves village Dungeon ####");
        String sleeve= p1.getSleeve();
        if(sleeve.equals("Archer")){
            System.out.println("you are an Archer So Dungeon will increase Attack Power");
        }
            ...
            System.out.println("\t ### You are not an Archer So Dungeon will limit your abilities ###");
