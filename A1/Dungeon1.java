...
public class Dungeon1 implements Dungeon
{
    ...
    {
        String sleeve = p1.getSleeve();
        System.out.println("\t ### you are now in Sword village Dungeon ####");
        if(sleeve.equals("SwordsMan")) {
            System.out.println("you are a SwordsMan So Dungeon will increase Attack Power");
        }
        else if ((sleeve.equals("Protagonist"))) {
            ...
            System.out.println("\t ### You are not a Swordsman So Dungeon will limit your abilities ###");
